...
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.qt-project.Qt.QPA.QPlatformIntegrationFactoryInterface.5.1" FILE "winrt.json")
...
{
    Q_UNUSED(paramList);
    if (system.toLower() == "winrt")
        return new QWinRTIntegration;
